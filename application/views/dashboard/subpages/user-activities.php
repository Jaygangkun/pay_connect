  ...
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      <div class="card-body">
        ...
        <div class="row mt-4">
          <div class="col-md-12">
            <table id="user_activities" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>S/N</th>
                  <th>UserName</th>
...
<!-- /.content -->
<style>
#user_activities_wrapper .row:first-of-type {
  display: none;
}
</style>
<script>
...
var table_user_activities = $('#user_activities').DataTable({
  ...
  "responsive": true,
  'ajax': {
    url: base_url + 'api-load-user-activities',
    data: function(d) {
...
$(document).on('keyup', '#search', function() {
  table_user_activities.search($(this).val()).draw(false);
})

$(document).on('click', '#btn_search', function() {
  table_user_activities.ajax.reload();
})
</script>